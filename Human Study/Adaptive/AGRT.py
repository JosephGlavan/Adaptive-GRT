...
def RunAdaptiveBlock (trialFun, numTrials, Xrange, Yrange, Xsteps=100, Ysteps=100, lapseRate=0.0, overallAcc=0.75, logfile=None, info=None, savePosterior=False, additionalArgs=None):
    """
...
def RunAdaptiveGRTExperiment (trialFunction, nAdaptiveTrials, nGRTtrials, 
                              ...
                              lapse=0.0, overallAccuracy=0.75, savePosterior=False,
